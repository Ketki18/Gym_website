...
// $pdf->Cell(10 ,5,'Fullname',0,0);
$pdf->Cell(90 ,5,"$fullname",0,1);

// $pdf->Cell(10 ,5,'EmailId:',0,0);
$pdf->Cell(90 ,5,"$email",0,1);

// $pdf->Cell(10 ,5,'Address:',0,0);
...
$pdf->SetFont('Arial','',12);
$pdf->Cell(130 ,5,'Premium 12-Months Membership',1,0);
$pdf->Cell(25 ,5,'-',1,0);
$pdf->Cell(34 ,5,'16,000',1,1,'R');//end of line

//summary
$pdf->Cell(130 ,5,'',0,0);
$pdf->Cell(25 ,5,'Subtotal',0,0);
$pdf->Cell(4 ,5,'$',1,0);
$pdf->Cell(30 ,5,'15,000',1,1,'R');//end of line
...
$pdf->Cell(4 ,5,'$',1,0);
$pdf->Cell(30 ,5,'16,000',1,1,'R');//end of line
